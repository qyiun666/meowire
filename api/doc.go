...
// kernel (Think → Act event stream) plus the six host ports and the bundled
// brain's parameters. The framework owns the loop, the events and the wiring contract; the host owns
